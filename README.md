...
## Второй стринт
логика компонентов на уровне компонентов
модули собирают компоненты и добавляют логику 
более высокого уровня 
(когда будет стор и чат инпут будет взамодествовать и чат контент)
страницы отрисовывают модули и добавляют логику если необходимо